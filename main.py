...
qa_pairs = {
    ...
    "5": "Silakan pilih layanan lebih lanjut:\n1. Pengajuan Informasi Publik\n2. Pengaduan\n3. Pengisian Survey Kepuasan\n\nMasukkan Angka 0 untuk kembali",
        "5.1": "Informasi Daftar Informasi Publik Bank Indonesia dapat diakses pada tautan berikut: https://www.bi.go.id/id/informasi-publik/informasi-publik/Default.aspx\nDalam hal ingin melakukan pengajuan informasi publik lainnya, dapat melakukan hal berikut:\n1. Pengisian Formulir Permintaan Informasi pada tautan (online): https://www.bi.go.id/id/layanan/permintaan-informasi/default.aspx\n2. Melakukan Pengisian Formulir Permintaan secara offline, dengan membawa kelengkapan data diri (copy KTP) dan/atau Surat Kuasa/Bukti Pengesahan Badan Hukum bagi pemohon yang mewakilkan lembaga atau organisasi; rincian informasi yang dibutuhkan; penjelasan tujuan penggunaan informasi; dan kelengkapan informasi relevan lainnya.\n\nMekanisme Permohonan Informasi Publik di KPwBI Purwokerto https://www.instagram.com/reel/DQ8PY0eElu1/?utm_source=ig_web_copy_link&igsh=MzRlODBiNWFlZA== ",
